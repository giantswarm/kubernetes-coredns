...
- Add `autopath` variable in the values file to make possible to configure it and disabled if it is needed.
...
[0.8.1]: https://github.com/giantswarm/kubernetes-coredns/pull/50
